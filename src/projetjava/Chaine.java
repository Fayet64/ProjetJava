...
public void produire (int nvx, int n){
    ...
    //regarder combien de produit on a besoin en entrée.BOF PAS BESOIN CAR ON CONNAIT DEJA LE CODE DE LA CHAINE 
     ...
     GererFichier.getChaineProd().get(1).entree.get(elements.get(1));
    ...
    if (GererFichier.getChaineProd().get(0).entree.get(elements.get(1)) > GererFichier.getElements().get(3).getQuantite()){
        if (GererFichier.getElements().get(3).getAchat()==0)
            System.out.println("Nous ne pouvons pas faire ce produit");
             else {
                 double l = GererFichier.getChaineProd().get(0).entree.get(elements.get(1)) - GererFichier.getElements().get(3).getQuantite();
                    Achat.ajoutQ(l);
    ...
    }else if (GererFichier.getChaineProd().get(0).entree.get(elements.get(2)) < GererFichier.getElements().get(1).getQuantite()){
        // la on rentre sur la deuxieme entree
               if (GererFichier.getChaineProd().get(0).entree.get(elements.get(2)) > GererFichier.getElements().get(1).getQuantite()){
                    if (GererFichier.getElements().get(1).getAchat()==0)
                    System.out.println("Nous ne pouvons pas faire ce produit");
               }else{ 
                 double l = GererFichier.getChaineProd().get(0).entree.get(elements.get(2)) - GererFichier.getElements().get(1).getQuantite();
                    Achat.ajoutQ(l);
                    System.out.println("le produit a ete commandé");
                    } 
            ...
            }else if (GererFichier.getChaineProd().get(0).entree.get(elements.get(3)) < GererFichier.getElements().get(2).getQuantite()){
                    // la on rentre sur la troisieme  entree
                         if (GererFichier.getChaineProd().get(0).entree.get(elements.get(3)) > GererFichier.getElements().get(2).getQuantite()){
                             if (GererFichier.getElements().get(1).getAchat()==0)
                                System.out.println("Nous ne pouvons pas faire ce produit");
                         }else{ 
                             double l = GererFichier.getChaineProd().get(0).entree.get(elements.get(3)) - GererFichier.getElements().get(2).getQuantite();
                              Achat.ajoutQ(l);
                            System.out.println("le produit a ete commandé");
                             } 
                         
            } else {
                double newQuante= GererFichier.getChaineProd().get(0).sortie.get(element(1));
                ...
                // retirer les quantité 
                        double newQuante1= GererFichier.getChaineProd().get(0).entree.get(element(1));
                        double newQuante2= GererFichier.getChaineProd().get(0).entree.get(element(2));
                        double newQuante3= GererFichier.getChaineProd().get(0).entree.get(element(3));
